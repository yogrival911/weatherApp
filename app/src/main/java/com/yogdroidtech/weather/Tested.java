...
public class Tested {
    ...
    @SerializedName("testpositivitylast7days")
    @Expose
    private String testpositivitylast7days;
    ...
    public String getTestpositivitylast7days() {
        return testpositivitylast7days;
    }

    public void setTestpositivitylast7days(String testpositivitylast7days) {
        this.testpositivitylast7days = testpositivitylast7days;
    }
